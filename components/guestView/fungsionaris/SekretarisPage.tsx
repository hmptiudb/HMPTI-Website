...
import { FiGithub, FiInstagram, FiMail, FiBookOpen, FiFileText } from "react-icons/fi";
import { IoSparkles, IoPeopleCircleOutline, IoDocumentTextOutline } from "react-icons/io5";
  ...
  useEffect(() => {
    const fetchMembers = async () => {
      try {
        ...
        // Filter members from Sekretaris division
        const sekretarisMembers = allMembers.filter((member) => member.division === "Sekretaris");

        // Sort members: Koordinator first, then others
        const sortedMembers = sekretarisMembers.sort((a, b) => {
        ...
        setError("Gagal memuat data sekretariat");
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        {/* Floating Shapes */}
        <motion.div
          className="absolute top-1/4 left-1/4 w-96 h-96 bg-green-200/10 rounded-full blur-3xl"
          animate={{
            x: [0, 20, 0],
            y: [0, -20, 0],
          }}
        ...
        />
        <motion.div
          className="absolute bottom-1/3 right-1/4 w-80 h-80 bg-emerald-200/10 rounded-full blur-3xl"
          animate={{
            x: [0, -15, 0],
            y: [0, 15, 0],
          }}
...
const LoadingScreen = () => (
  <div className="min-h-screen flex items-center justify-center bg-white">
    <div className="flex flex-col items-center">
      ...
      <p className="text-gray-600 font-medium">Memuat data sekretariat...</p>
    </div>
  </div>
);
  ...
  <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
    <div className="max-w-4xl mx-auto text-center">
      ...
      >
        ...
        <span className="text-sm font-medium text-green-700">Divisi Sekretaris</span>
      </motion.div>
      ...
      >
        Menjaga dokumentasi dan administrasi organisasi dengan presisi dan dedikasi tinggi
      </motion.p>
    </div>
  </section>
);
      ...
      <div className="max-w-6xl mx-auto">
          ...
          >
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Pemimpin yang mengarahkan dan mengkoordinasi kegiatan divisi sekretaris
              </p>
            </div>
        ...
        {regularMembers.length > 0 && (
          ...
          >
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Tim profesional yang menjalankan tugas administrasi dan dokumentasi
              </p>
            </div>
        ...
        {members.length === 0 && (
          ...
          >
            ...
            <p className="text-gray-500">Data anggota divisi sekretaris akan segera tersedia</p>
          </motion.div>
        )}
      </div>
    </section>
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      >
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Tugas Divisi Sekretaris</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Bertanggung jawab atas kelancaran administrasi dan dokumentasi organisasi
          </p>
        </div>
        ...
        >
          <p className="text-gray-600 italic">
            "Kesempurnaan dalam dokumentasi adalah cerminan dari profesionalisme organisasi."
          </p>
        </motion.div>
      </motion.div>
    </div>
