...
import { FiCode, FiCpu, FiGithub, FiInstagram, FiLayers, FiMail } from "react-icons/fi";

import { IoPeopleCircleOutline, IoRocketOutline, IoSparkles } from "react-icons/io5";
...
export default function RisetTeknologiPage() {
  ...
  useEffect(() => {
    ...
    const fetchMembers = async () => {
      try {
         ...
         *
         * Nilai ini mengikuti data Firestore
         * yang sudah digunakan project sebelumnya.
         */
        const membersQuery = query(membersCollection, where("division", "==", "Riset&Teknologi"));

        const snapshot = await getDocs(membersQuery);

        const risetTeknologiMembers = snapshot.docs.map(
          (document) =>
            ({
              id: document.id,
              ...document.data(),
         ...
         * di posisi pertama.
         *
         * Anggota lain diurutkan
         * berdasarkan nama.
         */
        const sortedMembers = risetTeknologiMembers.sort((a, b) => {
        ...
        if (isMounted) {
          setError("Gagal memuat data divisi riset & teknologi");
        }
      } finally {
        if (isMounted) {
          setLoading(false);
...
function LoadingScreen() {
  return (
    <main
      aria-busy="true"
      aria-label="Memuat data divisi Riset & Teknologi HMPTI"
      className="relative min-h-screen overflow-hidden bg-white"
    >
      <div aria-hidden="true" className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute inset-x-0 top-0 h-[420px] bg-gradient-to-br from-purple-50/50 via-white to-indigo-50/30" />
        ...
        <div className="absolute -left-32 top-32 hidden h-80 w-80 rounded-full bg-purple-100/40 blur-3xl md:block" />
        <div className="absolute -right-24 top-[430px] hidden h-80 w-80 rounded-full bg-indigo-100/30 blur-3xl md:block" />
      </div>
        ...
        <section className="px-4 py-10 sm:px-6 sm:py-14 lg:px-8 lg:py-16">
          <div className="mx-auto max-w-6xl">
            ...
            <div className="mt-10 flex items-center justify-center">
              <div className="inline-flex items-center gap-2 rounded-full border border-purple-100 bg-white/85 px-4 py-2 shadow-sm backdrop-blur-sm">
                <span className="h-2 w-2 rounded-full bg-purple-500 motion-safe:animate-pulse" />
                <span className="text-xs font-medium text-gray-500 sm:text-sm">Menyiapkan data Riset & Teknologi</span>
              </div>
            </div>
          </div>
        </section>
    ...
    >
      ...
      >
        <motion.div
          ...
          "
        >
          <IoRocketOutline className="text-purple-600" />
        ...
        <motion.p
          ...
          "
        >
          Mendorong inovasi dan pengembangan teknologi melalui penelitian dan eksperimen.
        </motion.p>
      </div>
    </section>
  );
      ...
      <div className="mx-auto max-w-6xl">
        ...
        {coordinators.length > 0 && (
          <motion.div
            ...
            "
          >
            <SectionHeading title="Koordinator Riset & Teknologi" description="Pemimpin yang mengarahkan dan mengkoordinasi kegiatan penelitian serta pengembangan teknologi." />
        ...
        {regularMembers.length > 0 && (
          ...
          >
            <SectionHeading title="Anggota Riset & Teknologi" description="Tim inovator yang mendorong perkembangan teknologi melalui penelitian dan pengembangan." />
        ...
        {members.length === 0 && (
          ...
          >
            ...
            <p
              ...
              "
            >
              Data anggota divisi riset & teknologi akan segera tersedia.
            </p>
          </motion.div>
        )}
      </div>
...
function DivisionInfoSection() {
  const responsibilities = [
    "Melakukan penelitian dan pengembangan teknologi terkini",
    "Mengembangkan solusi teknologi untuk kebutuhan organisasi",
    "Mengadakan workshop dan pelatihan teknologi",
    "Membuat proyek inovatif yang bermanfaat bagi anggota",
  ];

  const skills = [
    "Kemampuan pemrograman dan pengembangan software",
    "Pengetahuan tentang teknologi terkini dan tren masa depan",
    "Kemampuan penelitian dan analisis data",
        ...
        >
          ...
          >
            <div
              ...
              "
            >
              <FiCpu className="text-2xl text-purple-600" />
            </div>
            ...
            <p
              ...
              "
            >
              Bertanggung jawab atas penelitian, inovasi, dan pengembangan teknologi dalam organisasi.
            </p>
          </div>
          ...
          <div
            ...
            "
          >
            <DivisionInfoList icon={<IoSparkles className="text-purple-500" />} title="Tanggung Jawab Utama" items={responsibilities} dotClassName="bg-purple-500" />

            <DivisionInfoList icon={<FiLayers className="text-indigo-500" />} title="Keahlian yang Dibutuhkan" items={skills} dotClassName="bg-indigo-500" />
          </div>
          ...
          >
            <p
              ...
              "
            >
              &ldquo;Teknologi bukan hanya tentang alat, tetapi tentang bagaimana kita menciptakan masa depan yang lebih baik.&rdquo;
            </p>
          </motion.div>
        </motion.div>
      </div>
