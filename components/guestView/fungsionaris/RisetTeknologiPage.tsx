...
import { FiGithub, FiInstagram, FiMail, FiCode, FiCpu, FiLayers } from "react-icons/fi";
  ...
  useEffect(() => {
    const fetchMembers = async () => {
      try {
        ...
        // Filter members from Riset & Teknologi division
        const risetTeknologiMembers = allMembers.filter((member) => member.division === "Riset&Teknologi");
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 left-0 right-0 h-96 bg-gradient-to-br from-purple-50/30 to-indigo-50/20"></div>
        ...
        {/* Floating Shapes */}
        <motion.div
          className="absolute top-1/4 left-1/4 w-96 h-96 bg-purple-200/10 rounded-full blur-3xl"
          animate={{
            x: [0, 20, 0],
            y: [0, -20, 0],
          }}
  ...
  <div className="min-h-screen flex items-center justify-center bg-white">
    <div className="flex flex-col items-center">
      <motion.div
        ...
        className="w-16 h-16 bg-gradient-to-r from-purple-500 to-indigo-500 rounded-full flex items-center justify-center mb-4"
      >
        <IoRocketOutline className="text-white text-xl" />
      </motion.div>
      <p className="text-gray-600 font-medium">Memuat data riset & teknologi...</p>
    </div>
  </div>
);
  ...
  <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
    <div className="max-w-4xl mx-auto text-center">
      <motion.div
        ...
        className="inline-flex items-center gap-2 px-4 py-2 bg-purple-50 rounded-full border border-purple-100 mb-8"
      >
        <IoRocketOutline className="text-purple-500" />
        <span className="text-sm font-medium text-purple-700">Divisi Riset & Teknologi</span>
      </motion.div>
      ...
      <div className="max-w-6xl mx-auto">
          ...
          >
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Pemimpin yang mengarahkan dan mengkoordinasi kegiatan penelitian dan pengembangan teknologi
              </p>
            </div>
        ...
        {regularMembers.length > 0 && (
          ...
          >
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                Anggota Riset & Teknologi
              </h2>
              <p className="text-gray-600 max-w-2xl mx-auto">
                Tim inovator yang mendorong batas-batas teknologi melalui penelitian dan pengembangan
              </p>
            </div>
        ...
        {members.length === 0 && (
          ...
          >
            ...
            <p className="text-gray-500">Data anggota divisi riset & teknologi akan segera tersedia</p>
          </motion.div>
        )}
      </div>
    </section>
      ...
      <div className="relative aspect-square overflow-hidden">
        ...
        {isCoordinator && (
          <div className="absolute top-4 left-4">
            <span className="px-3 py-1.5 bg-gradient-to-r from-purple-600 to-indigo-500 text-white text-xs font-semibold rounded-full">
              Koordinator
            </span>
          </div>
        )}
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      >
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Tugas Divisi Riset & Teknologi</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
        ...
        <div className="mt-12 pt-8 border-t border-gray-100">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              { name: "Web Dev", color: "bg-purple-100 text-purple-700" },
              { name: "Mobile", color: "bg-indigo-100 text-indigo-700" },
              { name: "AI/ML", color: "bg-blue-100 text-blue-700" },
              { name: "Cloud", color: "bg-teal-100 text-teal-700" },
              { name: "IoT", color: "bg-green-100 text-green-700" },
              { name: "Data Science", color: "bg-yellow-100 text-yellow-700" },
              { name: "UI/UX", color: "bg-pink-100 text-pink-700" },
              { name: "DevOps", color: "bg-gray-100 text-gray-700" },
            ].map((tech, index) => (
              <div key={index} className={`px-3 py-2 rounded-lg text-center text-sm font-medium ${tech.color}`}>
                {tech.name}
              </div>
            ))}
          </div>
        ...
        >
          <p className="text-gray-600 italic">
            "Teknologi bukan hanya tentang alat, tetapi tentang bagaimana kita menciptakan masa depan yang lebih baik."
          </p>
        </motion.div>
      </motion.div>
    </div>
