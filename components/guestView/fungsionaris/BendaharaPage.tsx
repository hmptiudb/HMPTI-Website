...
import { FiGithub, FiInstagram, FiMail, FiDollarSign, FiTrendingUp } from "react-icons/fi";
import { IoSparkles, IoPeopleCircleOutline, IoCashOutline } from "react-icons/io5";
  ...
  useEffect(() => {
    const fetchMembers = async () => {
      try {
        ...
        // Filter members from Bendahara division
        const bendaharaMembers = allMembers.filter((member) => member.division === "Bendahara");
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 left-0 right-0 h-96 bg-gradient-to-br from-green-50/30 to-emerald-50/20"></div>
        ...
        {/* Floating Shapes */}
        <motion.div
          className="absolute top-1/4 left-1/4 w-96 h-96 bg-emerald-200/10 rounded-full blur-3xl"
          animate={{
            x: [0, 20, 0],
            y: [0, -20, 0],
          }}
        ...
        />
        <motion.div
          className="absolute bottom-1/3 right-1/4 w-80 h-80 bg-green-200/10 rounded-full blur-3xl"
          animate={{
            x: [0, -15, 0],
            y: [0, 15, 0],
          }}
  ...
  <div className="min-h-screen flex items-center justify-center bg-white">
    <div className="flex flex-col items-center">
      <motion.div
        ...
        className="w-16 h-16 bg-gradient-to-r from-green-500 to-emerald-500 rounded-full flex items-center justify-center mb-4"
      >
        <IoCashOutline className="text-white text-xl" />
      </motion.div>
      <p className="text-gray-600 font-medium">Memuat data bendahara...</p>
    </div>
  </div>
);
  ...
  <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
    <div className="max-w-4xl mx-auto text-center">
      <motion.div
        ...
        className="inline-flex items-center gap-2 px-4 py-2 bg-green-50 rounded-full border border-green-100 mb-8"
      >
        <IoCashOutline className="text-green-500" />
        <span className="text-sm font-medium text-green-700">Divisi Bendahara</span>
      </motion.div>
      ...
      <div className="max-w-6xl mx-auto">
          ...
          >
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Pemimpin yang mengarahkan dan mengkoordinasi pengelolaan keuangan organisasi
              </p>
            </div>
        ...
        {regularMembers.length > 0 && (
          ...
          >
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Tim profesional yang menjalankan tugas pengelolaan keuangan dan aset organisasi
              </p>
            </div>
        ...
        {members.length === 0 && (
          ...
          >
            ...
            <p className="text-gray-500">Data anggota divisi bendahara akan segera tersedia</p>
          </motion.div>
        )}
      </div>
    </section>
      ...
      <div className="relative aspect-square overflow-hidden">
        ...
        {isCoordinator && (
          <div className="absolute top-4 left-4">
            <span className="px-3 py-1.5 bg-gradient-to-r from-green-600 to-emerald-500 text-white text-xs font-semibold rounded-full">
              Koordinator
            </span>
          </div>
        )}
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      >
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Tugas Divisi Bendahara</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Bertanggung jawab atas pengelolaan keuangan dan aset organisasi dengan transparan
          </p>
        </div>
        ...
        >
          <p className="text-gray-600 italic">
            "Transparansi keuangan adalah pondasi kepercayaan dalam organisasi."
          </p>
        </motion.div>
      </motion.div>
    </div>
