...
import { FiCamera, FiGithub, FiInstagram, FiMail, FiShare2, FiVideo } from "react-icons/fi";

import { IoMegaphoneOutline, IoPeopleCircleOutline, IoSparkles } from "react-icons/io5";
  ...
  useEffect(() => {
    ...
    const fetchMembers = async () => {
      try {
        ...
        /*
         * Hanya mengambil anggota divisi Kominfo.
         * Tidak lagi mengambil seluruh member.
         */
        const membersQuery = query(membersCollection, where("division", "==", "Kominfo"));

        const snapshot = await getDocs(membersQuery);

        const kominfoMembers = snapshot.docs.map(
          (document) =>
            ({
              id: document.id,
              ...document.data(),
        ...
        /*
         * Koordinator berada di posisi pertama.
         * Anggota lainnya diurutkan berdasarkan nama.
         */
...
function LoadingScreen() {
  return (
    <main
      aria-busy="true"
      aria-label="Memuat data divisi Kominfo HMPTI"
      className="relative min-h-screen overflow-hidden bg-white"
    >
      <div aria-hidden="true" className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute inset-x-0 top-0 h-[420px] bg-gradient-to-br from-amber-50/50 via-white to-orange-50/30" />
        ...
        <div className="absolute -left-32 top-32 hidden h-80 w-80 rounded-full bg-amber-100/40 blur-3xl md:block" />
        <div className="absolute -right-24 top-[430px] hidden h-80 w-80 rounded-full bg-orange-100/30 blur-3xl md:block" />
      </div>
        ...
        <section className="px-4 py-10 sm:px-6 sm:py-14 lg:px-8 lg:py-16">
          <div className="mx-auto max-w-6xl">
            ...
            <div className="mt-10 flex items-center justify-center">
              <div className="inline-flex items-center gap-2 rounded-full border border-amber-100 bg-white/85 px-4 py-2 shadow-sm backdrop-blur-sm">
                <span className="h-2 w-2 rounded-full bg-amber-500 motion-safe:animate-pulse" />
                <span className="text-xs font-medium text-gray-500 sm:text-sm">Menyiapkan data Kominfo</span>
              </div>
            </div>
          </div>
        </section>
    ...
    >
      ...
      >
        <motion.div
          ...
          "
        >
          <IoMegaphoneOutline className="text-amber-600" />
      ...
      <div className="mx-auto max-w-6xl">
        ...
        {coordinators.length > 0 && (
          <motion.div
            ...
            "
          >
            <SectionHeading title="Koordinator Kominfo" description="Pemimpin yang mengarahkan strategi komunikasi dan penyebaran informasi organisasi." />
        ...
        {regularMembers.length > 0 && (
          ...
          >
            <SectionHeading title="Anggota Kominfo" description="Tim kreatif yang menghubungkan organisasi dengan dunia melalui konten berkualitas." />
        ...
        {members.length === 0 && (
          ...
          >
            ...
            <p
              ...
              "
            >
              Data anggota divisi kominfo akan segera tersedia.
            </p>
          </motion.div>
        )}
      </div>
...
function DivisionInfoSection() {
  ...
  const platforms = [
    ...
    {
      name: "TikTok",
      className: "bg-gray-900 text-white ring-gray-900",
    },
    {
      name: "Newsletter",
        ...
        >
          ...
          >
            <div
              ...
              "
            >
              <FiShare2 className="text-2xl text-amber-600" />
            </div>
          ...
          <div
            ...
            "
          >
            <DivisionInfoList icon={<IoSparkles className="text-amber-500" />} title="Tanggung Jawab Utama" items={responsibilities} dotClassName="bg-amber-500" />

            <DivisionInfoList icon={<FiCamera className="text-orange-500" />} title="Keahlian yang Dibutuhkan" items={skills} dotClassName="bg-orange-500" />
          </div>
          ...
          >
            <p
              ...
              "
            >
              &ldquo;Komunikasi yang efektif adalah jembatan antara ide dan realitas, antara organisasi dan dunia.&rdquo;
            </p>
          </motion.div>
        </motion.div>
      </div>
