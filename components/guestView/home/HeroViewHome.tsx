...
export default function HeroViewHome() {
  return (
    <div className="relative flex items-center justify-center w-full min-h-screen overflow-hidden px-4 pt-6 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-50 via-white to-blue-50 text-gray-900">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <span className="block bg-gradient-to-r from-[#374785] via-blue-600 to-cyan-600 text-transparent bg-clip-text mt-2">
                  Teknik Informatika
                </span>
              </motion.h1>
            ...
            >
              <motion.div whileHover={{ y: -2 }} whileTap={{ scale: 0.98 }}>
                <Link
                  ...
                  className="flex items-center gap-3 px-8 py-4 rounded-xl font-medium transition-all duration-300 group bg-gradient-to-r from-[#374785] to-blue-600 text-white hover:shadow-lg hover:shadow-blue-500/25"
                >
              ...
              <motion.div whileHover={{ y: -2 }} whileTap={{ scale: 0.98 }}>
                <Link
                  href="/pages/event"
                  className="flex items-center gap-3 px-8 py-4 rounded-xl font-medium border-2 transition-all duration-300 bg-white text-gray-700 border-gray-200 hover:border-blue-300 hover:bg-blue-50 hover:shadow-md"
                >
            ...
            {/* Stats section */}
            <motion.div 
              className="flex flex-wrap gap-6 pt-8 border-t border-gray-100"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
          ...
          >
            <div className="relative group">
              {/* Main card */}
              <div className="relative bg-white rounded-2xl p-8 shadow-2xl shadow-blue-500/10 border border-gray-100 transform group-hover:shadow-2xl group-hover:shadow-blue-500/20 transition-all duration-500">
                {/* Decorative elements */}
                ...
                <div className="relative p-6 bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl border border-gray-100">
                  <img 
                    ...
                    alt="HMPTI Logo" 
                    className="w-full max-w-xs h-auto object-contain transform group-hover:scale-105 transition-transform duration-700" 
                  />
