...
function NewsForm({ existingData, onClose }: { existingData?: NewsItem; onClose: () => void }) {
  ...
  const [dateCreated, setDateCreated] = useState(existingData?.dateCreated || "");
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (existingData) {
        await updateDoc(doc(newsCollection, existingData.id), {
          descriptionNews,
          writterNews,
          titleNews,
          categoryNews,
        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
              <div>
                <h1 className="text-2xl font-semibold text-gray-800">Manajemen Berita</h1>
                <p className="text-gray-500 text-sm mt-1">Kelola berita dan artikel yang ditampilkan di website</p>
              </div>
              <button
